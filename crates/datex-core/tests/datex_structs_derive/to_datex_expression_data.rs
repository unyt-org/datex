...
use datex_core::ast::expressions::{DatexExpressionData, Map};
use datex_core::ast::spanned::Spanned;
use datex_core::traits::to_datex_expression_data::ToDatexExpressionData;
...
fn test_to_datex_expression_data() {
    ...
    assert_eq!(
        ...
        DatexExpressionData::Map(Map::new(
            vec![
                (DatexExpressionData::Text("field1".into()).with_default_span(), DatexExpressionData::TypedInteger(TypedInteger::I32(42)).with_default_span()),
                (DatexExpressionData::Text("field2".into()).with_default_span(), DatexExpressionData::Text("Hello, Datex!".into()).with_default_span()),
            ]
        ))
    );
}
...
fn test_to_datex_expression_data_nested() {
    ...
    assert_eq!(
        ...
        DatexExpressionData::Map(Map::new(
            vec![
                (DatexExpressionData::Text("nested".into()).with_default_span(), DatexExpressionData::Map(Map::new(
                    vec![
                        (DatexExpressionData::Text("field1".into()).with_default_span(), DatexExpressionData::TypedInteger(TypedInteger::I32(42)).with_default_span()),
                        (DatexExpressionData::Text("field2".into()).with_default_span(), DatexExpressionData::Text("Hello, Datex!".into()).with_default_span()),
                    ]
                )).with_default_span()),
                (DatexExpressionData::Text("field3".into()).with_default_span(), DatexExpressionData::Text("Nested Test".into()).with_default_span()),
            ]
        ))
    );
}