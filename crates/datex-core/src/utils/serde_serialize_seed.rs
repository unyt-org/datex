...
impl<'de, U: DeserializeSeed<'de>, V: DeserializeSeed<'de>> de::Visitor<'de>
    for PairDeVisitor<U, V>
where
    U::Value: Sized,
    V::Value: Sized,
{
...
impl<'de, U: DeserializeSeed<'de>, V: DeserializeSeed<'de>> DeserializeSeed<'de>
    for PairSerde<U, V>
where
    U::Value: Sized,
    V::Value: Sized,
...
> de::Visitor<'de> for Tuple4DeVisitor<T1, T2, T3, T4>
where
    T1::Value: Sized,
    T2::Value: Sized,
    T3::Value: Sized,
    T4::Value: Sized,
{
        ...
        A: SeqAccess<'de>,
    {
        ...
        let t3 = seq
            .next_element_seed(self.0.2)?
            .ok_or_else(|| A::Error::invalid_length(2, &"tuple 4"))?;
        let t4 = seq
            .next_element_seed(self.0.3)?
...
impl<'de, T: DeserializeSeed<'de> + Clone> de::Visitor<'de> for VecDeVisitor<T>
where
    T::Value: Sized,
{
