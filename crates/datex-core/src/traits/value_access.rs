...
/// Trait for accessing properties of a value as [ValueContainers] or [ValueContainerOrCallable]. This is used for accessing properties of values in a generic way, such as for maps and structs.
pub trait ValueAccess {
    ...
    /// This method returns a [ValueContainerOrCallable] which can be either a [ValueContainer] or a [Callable] value.
    fn try_get_property(
        &self,
