...
impl TryClone for CoreValue
{
    fn try_clone(&self) -> Result<CoreValue, ()> {
        match self {
            ...
            CoreValue::TypedInteger(typed_int_value) => typed_int_value.try_clone(),
            CoreValue::Decimal(decimal_value) => decimal_value.try_clone(),
            CoreValue::TypedDecimal(typed_decimal_value) => typed_decimal_value.try_clone(),
            ...
            CoreValue::EntityTypeDefinition(entity_type_def) => entity_type_def.try_clone(),
