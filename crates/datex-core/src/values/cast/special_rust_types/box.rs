...
mod tests {
    ...
    fn boxed_integer() {
        ...
        let value: Value = boxed_integer.to_value();
        assert!(matches!(
            value.inner,
    ...
    fn endpoint_boxed() {
        ...
        let value: Value = boxed_endpoint.to_value();
        assert!(matches!(
            value.inner,
    ...
    fn datex_type() {
        ...
        let boxed_type = Box::<Endpoint>::datex_type(&mut memory);
        let endpoint_type = Endpoint::datex_type(&mut memory);
