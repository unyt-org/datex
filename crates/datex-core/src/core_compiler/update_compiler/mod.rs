...
mod tests {
    ...
    use crate::global::protocol_structures::instruction_data::UInt8Data;
    ...
    fn test_compile_update() {
        ...
        let dxb_with_shared_values =
            compile_updates(container.clone(), &[&update_data], compile_input);
        ...
        assert_regular_instructions_equal!(
            ...
            (RegularInstruction::statements_with_children(
                ...
                instructions!(
                    ...
                    RegularInstruction::SetPropertyText(ShortTextData("test_key".to_string())).with_children(instructions!(
