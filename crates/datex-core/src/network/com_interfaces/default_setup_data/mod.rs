//! This module contains the implementation of the communication interfaces for DATEX, such as [http], [serial], [tcp], [webrtc], and [websocket].
pub mod http;
pub mod http_common;
pub mod serial;
pub mod tcp;
...
macro_rules! derive_setup_data {
    ($new_type:ident, $setup_data_type:ty) => {
        #[derive(
            serde::Deserialize, serde::Serialize, datex_core::macros::Datex,
        )]
