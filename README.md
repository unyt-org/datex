...
- [crates/](./crates) - Contains all the Rust crates for the DATEX ecosystem
  ...
  - [datex-crypto-facade/](./crates/datex-crypto-facade) - A facade crate providing a unified interface for different DATEX Crypto implementations
  - [datex-crypto-esp32/](./crates/datex-crypto-esp32) - An embedded implementation of the DATEX Crypto trait for ESP32 targets
  ...
  - [datex-macros-internal/](./crates/datex-macros-internal) - Procedural macros used in the internal implementation of the DATEX crate
...
- [assets/](./assets) - Assets for the DATEX ecosystem such as logos and images
...
- [DATEX Web](https://github.com/unyt-org/datex-web) - A JavaScript
  interface to the DATEX Core. Includes a
...
- [DATEX CLI](https://github.com/unyt-org/datex-native) - A command line interface for DATEX that provides a simple way to run
  DATEX scripts and interact with the DATEX Runtime in a REPL-like environment.
- [DATEX Native](https://github.com/unyt-org/datex-native) - The DATEX library for native platforms
- [DATEX Embedded](https://github.com/unyt-org/datex-embedded) - A extension crate for the DATEX Core crate that provides interfaces and helpers for running DATEX on embedded targets.
- [DATEX CPP](https://github.com/unyt-org/datex-cpp) - A C++ port of
